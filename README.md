...
Structs and modular program design (.h and .c files)

File I/O, command-line arguments, and error handling

Algorithmic challenges (sorting, searching, recursion)

Data structures: linked lists, stacks, and queues

Assembler Project (C Final Project):
...
Machine code generation: writes the corresponding binary to the output file

Validation pass: checks for unimplemented identifiers using a flag system

Uses structs and dynamic memory allocation to simulate assembler memory
...
Compiler: GCC with -std=c90 flag
...
The assembler project simulates memory and instruction handling using structs and dynamic allocation.
